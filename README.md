...
- **Nodos editables**: arrastra vértices de rutas y formas para ajustar su trazado directamente en el mapa.
...
src/
  ...
  services/        storage (IndexedDB singleton), export, mapora-file
